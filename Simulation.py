...
##########POTENTIAL ACCELERATION FORMULAS########################
#acc = abs(((car.data_arr[i-car.rt][1]*1.3/1.47)-car.data_arr[i-car.rt][0])/
#                        (car.data_arr[i-car.rt][0]))   
#                    acc *= ((car.data_arr[i-car.rt][0]*1.47/1.3) - 
#                        car.data_arr[i-car.rt][1])

#1.2*(DP/P)*(DV-V)  <--good if you set a == 0 if approaching next car